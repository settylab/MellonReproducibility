#! /usr/bin/env python
#SBATCH --job-name=mellon_stability_ls
#SBATCH --nodes=1
...
BASE_OUT_PATH = '/fh/fast/setty_m/user/dotto/CellDensities/data/benchmarks/subsamples/stability_ls/'
...
def make_estimator(sub_id, X, n_landmarks=5000):
    ...
    est = mellon.DensityEstimator(n_landmarks=n_landmarks, ls_factor=ls_factor)
    return est
