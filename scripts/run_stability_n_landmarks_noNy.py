#! /usr/bin/env python
#SBATCH --job-name=mellon_stability_n_landmarks_noNy
#SBATCH --nodes=1
...
BASE_OUT_PATH = '/fh/fast/setty_m/user/dotto/CellDensities/data/benchmarks/subsamples/stability_n_landmarks_noNy/'
...
def make_estimator(sub_id, X, n_landmarks=5000):
    ...
    if n_landmarks <= 1:
        ...
        sys.exit(0)
    est = mellon.DensityEstimator(n_landmarks=int(new_n_landmarks), rank=1., method='percent')
    return est
