#! /usr/bin/env python
#SBATCH --job-name=mellon_benchmarks_noNy_1core
#SBATCH --nodes=1
...
BASE_OUT_PATH = '/fh/fast/setty_m/user/dotto/CellDensities/data/benchmarks/subsamples/hierarchical_noNy_1core/'
...
def run_density_estimation(ad, X, n_landmarks=5000):
    ...
    estimator = mellon.DensityEstimator(n_landmarks=n_landmarks, rank=1., method='percent')
    print('density...')
    estimator._set_x(X)
